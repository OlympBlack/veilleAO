...
const modifierMotDePasse = () => {
  toast.add({
    ...
    description:
      "Veuillez vérifier vos emails pour modifier votre mot de passe.",
    color: "green",
  });
};
    ...
    <div class="p-6 max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p class="text-sm text-zinc-500 dark:text-zinc-400">
          Gérez votre compte et vos préférences de recherche.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="md:col-span-1">
          ...
          <p class="text-sm text-zinc-500 mt-1">
            Vos informations d'accès à la plateforme VeilleAO.
          </p>
        </div>
        ...
        <UCard class="md:col-span-2">
          <div class="space-y-6">
            <UFormGroup
              ...
              help="Ce champ n'est pas modifiable pour le moment."
            >
            ...
            <UFormGroup label="Mot de passe">
              <div class="flex items-center gap-4">
                <UInput
                  ...
                  icon="i-lucide-lock"
                />
                <UButton color="white" @click="modifierMotDePasse"
                  >Modifier</UButton
                >
              </div>
            </UFormGroup>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="md:col-span-1">
          ...
          <p class="text-sm text-zinc-500 mt-1">
            Définissez vos critères par défaut pour la détection des
            opportunités.
          </p>
        </div>
        ...
        <UCard class="md:col-span-2">
          <div class="space-y-6">
            <div class="space-y-1">
              ...
              >
                Nombre minimum de jours restants avant la date limite
              </label>
            ...
            <div class="space-y-2">
              <h3 class="text-sm font-medium text-zinc-900 dark:text-zinc-100">
                Domaines d'activité recherchés
              </h3>
